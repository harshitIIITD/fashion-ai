...
> {
  ...
  createInvocation(params: SizeConversionParams): ToolInvocation<SizeConversionParams, SizeConversionResult> {
    return {
      params,
      getDescription: () => {
  ...
  private async execute(params: SizeConversionParams): Promise<SizeConversionResult> {
    ...
    const result: SizeConversionResult = {
      ...
      returnDisplay: this.formatConversionResults(params, conversion, sizeChart, notes),
  ...
  private convertSize(params: SizeConversionParams): string {
    ...
    const conversionTables: Record<string, Record<string, Record<string, string>>> = {
      'Tops': {
        'US_to_EU': { 'XS': '32', 'S': '34', 'M': '36', 'L': '38', 'XL': '40', '0': '32', '2': '34', '4': '36', '6': '38', '8': '40' },
        'EU_to_US': { '32': 'XS', '34': 'S', '36': 'M', '38': 'L', '40': 'XL' },
        'US_to_UK': { 'XS': '6', 'S': '8', 'M': '10', 'L': '12', 'XL': '14', '0': '4', '2': '6', '4': '8', '6': '10', '8': '12' },
        'UK_to_US': { '6': 'XS', '8': 'S', '10': 'M', '12': 'L', '14': 'XL' },
      },
      'Shoes': {
        'US_to_EU': { '5': '35', '6': '36', '7': '37', '8': '38', '9': '39', '10': '40', '11': '41' },
        'EU_to_US': { '35': '5', '36': '6', '37': '7', '38': '8', '39': '9', '40': '10', '41': '11' },
        'US_to_UK': { '5': '3', '6': '4', '7': '5', '8': '6', '9': '7', '10': '8', '11': '9' },
        'UK_to_US': { '3': '5', '4': '6', '5': '7', '6': '8', '7': '9', '8': '10', '9': '11' },
      },
    };
  ...
  private generateSizeChart(params: SizeConversionParams): Array<{ region: string; size: string; measurements?: string; }> {
    // Generate a sample size chart for the category
    const charts: Record<string, Array<{ region: string; size: string; measurements?: string; }>> = {
      'Tops': [
  ...
  private getConversionNotes(params: SizeConversionParams): string {
    ...
    if (params.category === 'Shoes') {
      notes.push(`Shoe sizes can vary significantly by brand and style. Try before buying when possible.`);
    }

    if (params.category === 'Jeans') {
      notes.push(`Denim sizing often uses waist measurements in inches or centimeters.`);
    }
